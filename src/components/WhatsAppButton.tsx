...
const variants: Record<Variant, string> = {
  ...
  fab: 'fixed z-40 bottom-6 left-4 flex h-14 w-14 min-h-11 min-w-11 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg hover:bg-[#1ebe57] md:left-6',
}
